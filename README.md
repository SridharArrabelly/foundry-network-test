...
- The Foundry account becomes selectively public for `ALLOWED_IP_ADDRESS`; everything else stays private. The agent runtime (in the Microsoft-managed VNet) is **not** affected.
